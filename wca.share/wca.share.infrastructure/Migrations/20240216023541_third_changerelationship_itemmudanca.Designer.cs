...
namespace wca.share.infrastructure.Migrations
{
    ...
    [Migration("20240216023541_third_changerelationship_itemmudanca")]
    partial class third_changerelationship_itemmudanca
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ItemMudancaSolicitacaoMudancaBase", b =>
                {
                    ...
                    b.Property<int>("MudancaBasesSolicitacaoId")
                        .HasColumnType("int");

                    b.HasKey("ItensMudancaId", "MudancaBasesSolicitacaoId");

                    b.HasIndex("MudancaBasesSolicitacaoId");
            ...
            modelBuilder.Entity("ItemMudancaSolicitacaoMudancaBase", b =>
                {
                    ...
                    b.HasOne("wca.share.domain.Entities.SolicitacaoMudancaBase", null)
                        .WithMany()
                        .HasForeignKey("MudancaBasesSolicitacaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
