...
namespace wca.share.infrastructure.Migrations
{
    ...
    [Migration("20241221005546_CreateTable_Supervisor_AlterTable_Solicitacao_AddColumn_SupervisorId")]
    partial class CreateTable_Supervisor_AlterTable_Solicitacao_AddColumn_SupervisorId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocumentoComplementarSolicitacaoVaga", b =>
                {
                    ...
                    b.HasKey("DocumentoComplementaresId", "SolicitacaoVagaSolicitacaoId");

                    b.HasIndex("SolicitacaoVagaSolicitacaoId");

                    b.ToTable("DocumentoComplementarSolicitacaoVaga");
                });
            ...
            modelBuilder.Entity("wca.share.domain.Entities.EventLogGi", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("wca.share.domain.Entities.ItemMudanca", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Ativo = true,
                            Descricao = "Alteração de benefícios"
                        },
                        new
                        {
                            Id = 2,
                            Ativo = true,
                            Descricao = "Alteração de salário"
                        },
                        new
                        {
                            Id = 3,
                        ...
                        new
                        {
                            Id = 4,
                            Ativo = true,
                            Descricao = "Exclusão insalubridade"
                        },
                        new
                        {
                            Id = 5,
                            Ativo = true,
                            Descricao = "Exclusão periculosidade"
                        },
                        new
                        {
                            Id = 6,
                            Ativo = true,
                            Descricao = "Inclusão insalubridade"
                        },
                        new
                        {
                            Id = 7,
                            Ativo = true,
                            Descricao = "Inclusão periculosidade"
                        });
                });
            ...
            modelBuilder.Entity("wca.share.domain.Entities.StatusSolicitacao", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Notifica = 1,
                            Status = "Pendente",
                            StatusIntermediario = "Pendente",
                            TemplateNotificacao = "Novo(a) {TipoSolicitacao} solicitado(a) - código: #{id}!"
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Notifica = 0,
                            Status = "Em Andamento",
                            StatusIntermediario = "Em Andamento"
                        },
                        new
                        {
                            Id = 3,
                        ...
                        new
                        {
                            ...
                            ProximoStatusId = 1,
                            Status = "Pendente",
                            StatusIntermediario = "Aguardando Aprovação",
                            TemplateNotificacao = "{TipoSolicitacao} #{id} está aguardando aprovação!"
                        },
                        new
                        {
                            Id = 5,
                            ...
                            Notifica = 1,
                            Status = "Concluído",
                            StatusIntermediario = "Reprovado",
                            TemplateNotificacao = "{TipoSolicitacao} #{id} reprovado(a)!"
                        },
                        new
                        {
                            Id = 6,
                            ...
                            Notifica = 0,
                            Status = "Concluído",
                            StatusIntermediario = "Cancelado"
                        });
                });

            modelBuilder.Entity("wca.share.domain.Entities.Supervisor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("wca.share.domain.Entities.Solicitacao", b =>
                {
                    ...
                    b.HasOne("wca.share.domain.Entities.Supervisor", "Supervisor")
                        .WithMany()
            ...
            modelBuilder.Entity("wca.share.domain.Entities.SolicitacaoVaga", b =>
                {
                    ...
                    b.HasOne("wca.share.domain.Entities.Solicitacao", "Solicitacao")
                        .WithOne("Vaga")
                        .HasForeignKey("wca.share.domain.Entities.SolicitacaoVaga", "SolicitacaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
