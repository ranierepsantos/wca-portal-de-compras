...
namespace wca.compras.data.Migrations
{
    ...
    [Migration("20230104223559_SeedInitialData")]
            ...
            modelBuilder.Entity("wca.compras.domain.Entities.Permissao", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Descricao = "Permite alterar, incluir e visualizar dados da filial",
                            Nome = "Filial",
                            Regra = "filial"
                        },
                        new
                        {
                            Id = 2,
                            Descricao = "Permite alterar, incluir e visualizar dados do cliente",
                            Nome = "Clientes",
                            Regra = "cliente"
                        },
                        new
                        {
                            Id = 3,
                            Descricao = "Permite alterar, incluir e visualizar dados do usuário",
                            Nome = "Usuários",
                            Regra = "usuario"
                        },
                        new
                        {
                            Id = 4,
                            Descricao = "Permite alterar, incluir e visualizar dados do perfil",
                            Nome = "Perfil",
                            Regra = "perfil"
                        },
                        new
                        {
                            Id = 5,
                            Descricao = "Permite alterar, incluir e visualizar dados do fornecedor",
                            Nome = "Fornecedores",
                            Regra = "fornecedor"
                        },
                        new
                        {
                            Id = 6,
                            Descricao = "Permite alterar, incluir e visualizar dados da requisição do usuário",
                            Nome = "Requisição",
                            Regra = "requisicao"
                        },
                        new
                        {
                            Id = 7,
                            Descricao = "Permite visualizar dados de requisição de todos usuários",
                            Nome = "Administrador Requisição",
                            Regra = "requisicao_all_users"
                        },
                        new
                        {
                            Id = 8,
                            Descricao = "Permite aprovar requisição",
                            Nome = "Aprovar Requisição",
                            Regra = "aprova_requisicao"
                        });
                });
