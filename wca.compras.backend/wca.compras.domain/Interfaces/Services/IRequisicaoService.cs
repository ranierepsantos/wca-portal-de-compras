...
namespace wca.compras.domain.Interfaces.Services
{
    public interface IRequisicaoService
    {
        ...
        Pagination<RequisicaoDto> Paginate(int filialId, int page = 1, int pageSize = 10, int clienteId = 0, int fornecedorId = 0, int usuarioId = 0, EnumStatusRequisicao status = EnumStatusRequisicao.TODOS, DateTime? dataInicio = null, DateTime? dataFim = null);
        ...
        Task<Stream> ExportToExcel(int filialId, int clienteId, int fornecedorId, int usuarioId, EnumStatusRequisicao status = EnumStatusRequisicao.TODOS, DateTime? dataInicio = null, DateTime? dataFim = null);
