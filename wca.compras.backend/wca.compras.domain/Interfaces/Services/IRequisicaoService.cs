...
namespace wca.compras.domain.Interfaces.Services
{
    public interface IRequisicaoService
    {
        ...
        Pagination<RequisicaoDto> Paginate(int[] filials, int authUserId = 0, int page = 1, int pageSize = 10, int clienteId = 0, int usuarioId = 0, int fornecedorId = 0, DateTime? dataInicio = null, DateTime? dataFim = null, params int[] status);
        ...
        Task<Stream> ExportToExcel(int[] filials, int clienteId, int fornecedorId, int usuarioId, DateTime? dataInicio = null, DateTime? dataFim = null, int authUserId = 0, params int[] status);
        ...
        Pagination<RequisicaoDto> PaginateByContextUser(int[] filials, int logedUserId, int page = 1, int pageSize = 10, int clienteId = 0, int usuarioId = 0, int fornecedorId = 0, DateTime? dataInicio = null, DateTime? dataFim = null, params int[] status);
    }
}
