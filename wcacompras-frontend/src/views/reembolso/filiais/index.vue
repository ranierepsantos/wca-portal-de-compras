...
import { Filial, useFilialStore} from "@/store/reembolso/filial.store"
...
async function getItems()
{
  ...
  {
    isBusy.value = true;
    let response = await filialStore.getPaginate(page.value, pageSize, filter.value);
    filiais.value = response.items;
