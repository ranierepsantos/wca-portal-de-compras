...
namespace wca.reembolso.infrastruture.Migrations
{
    ...
    [Migration("20250702005457_Create_PerfilTipoDespesas")]
    partial class Create_PerfilTipoDespesas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("wca.reembolso.domain.Entities.Faturamento", b =>
                {
                    ...
                    b.Property<DateTime?>("DataChatBotMessage")
                        .HasColumnType("smalldatetime")
                        .HasColumnName("data_chatbot_message");
                    ...
                    b.Property<string>("NumeroDS")
                        .HasColumnType("varchar(500)")
                        .HasColumnName("numero_ds");
            ...
            modelBuilder.Entity("wca.reembolso.domain.Entities.PerfilTipoDespesa", b =>
                {
                    ...
                    b.HasKey("PerfilId", "TipoDespesaId");

                    b.HasIndex("TipoDespesaId");

                    b.ToTable("Perfil_TipoDespesa");
                });
            ...
            modelBuilder.Entity("wca.reembolso.domain.Entities.StatusChatBotMensagem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EnviarPara")
                        .HasColumnType("int")
                        .HasColumnName("enviar_para")
                        .HasComment("Tipo de usuário que será enviado: 1- Gestor WCA, 2 - Gestor Cliente, 3 - Colaborador");
                    ...
                    b.Property<int>("TipoSolicitacao")
                        .HasColumnType("int")
                        .HasColumnName("tipo_solicitacao")
                        .HasComment("Tipo de solicitação que será enviado: 0 - Ambas 1 - Reembolso, 2 - Adiantamento");

                    b.HasKey("Id");

                    b.HasIndex("StatusSolicitacaoId", "EnviarPara")
                        .IsUnique();

                    b.ToTable("Status_ChatBot_Mensagem");
                });
            ...
            modelBuilder.Entity("wca.reembolso.domain.Entities.TipoDespesa", b =>
                {
                    ...
                    b.Property<bool>("ExibirParaColaborador")
                        .HasColumnType("bit")
                        .HasColumnName("exibir_para_colaborador");

                    b.Property<bool>("FaturarCliente")
                        .HasColumnType("bit")
                        .HasColumnName("faturar_cliente");
                    ...
                    b.Property<bool>("ReembolsarColaborador")
                        .HasColumnType("bit")
                        .HasColumnName("reembolsar_colaborador");
